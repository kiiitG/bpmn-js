...
BpmnImporter.prototype.importBpmnDiagram = function(definitions, bpmnDiagram, warnings) {
  render(definitions, bpmnDiagram, this._canvas, this, this._translate, warnings);
};
