...
function add(semantic, di, parentElement, service) {
  ...
  var handlers = {
    ...
    'bpmndi:BPMNShape': function() {
      ...
      if (is(semantic, 'bpmn:BoundaryEvent')) {
        attachBoundary(semantic, element, service._translate, service._elementRegistry);
      }
  ...
  addLabel(semantic, di, element, service._elementFactory, service._canvas, service._textRenderer);
