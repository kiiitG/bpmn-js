...
function getEnd(semantic, side, service) {
  ...
  element = refSemantic && getElement(refSemantic, service);
...
function getSource(semantic, service) {
  return getEnd(semantic, 'source', service);
}

function getTarget(semantic, service) {
  return getEnd(semantic, 'target', service);
}

function getElement(semantic, service) {
  return service._elementRegistry.get(semantic.id);
}
