...
export default function BpmnTreeWalker(handler, translate) {
  ...
  function getRoot(definitions, plane) {
  ...
  function handleSemantic(definitions, diagram) {
    var rootElement = getRoot(definitions, diagram.plane);
    var ctx = visitRoot(rootElement, diagram.plane);
